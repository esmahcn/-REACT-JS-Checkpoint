      ...
      <div className="App">
        ...
        <Container>
          <Row>
            <Col md={4}>
              <Card>
                <Card.Img variant="top" src="/img/photo-1506744038136-46273834b3fb.avif" />
                <Card.Body>
            ...
            <Col md={4}>
              <Card>
                <Card.Img variant="top" src="/img/photo-1494526585095-c41746248156.avif" />
                <Card.Body>
            ...
            <Col md={4}>
              <Card>
                <Card.Img variant="top" src="/img/photo-1500534623283-312aade485b7.avif" />
                <Card.Body>
